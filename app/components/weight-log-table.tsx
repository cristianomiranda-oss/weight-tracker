...
export default function WeightLogTable({
  ...
  return (
    <div className="w-full h-full min-h-46 max-h-full flex flex-col bg-dusty-taupe-500 overflow-y-scroll scrollbar-track-dusty-taupe-700 scrollbar-thumb-turf-green-600">
