...
export default function WeightLogTable({
  ...
  return (
    <div className="w-full h-full min-h-46 flex flex-col bg-container overflow-y-scroll scrollbar-track-container-secondary scrollbar-thumb-foreground ">
      <div className="w-full h-12 min-h-12 md:h-16 md:min-h-16 sticky top-0 flex justify-center items-center border-b-2 text-3xl md:text-4xl bg-header-footer">
